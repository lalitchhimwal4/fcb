...
<section class="main-page-wrap">
    <div class="member-enrollment-sec">
        ...
        <div class="enroll-content-outer">
            <form action="{{route('member.checklogin')}}" method="POST" id="member_login_form">
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form action="{{route('resetpassword')}}" method="post" id="edit_provider_details">
                    <div class="container">
                        @csrf
                        ...
                        <div class="row" id="find_office">
                            ...
                            <div class="col-lg-4 col-lg-4 col-sm-12 col-12">
                                <b>Postal Code</b>
                                <input type="text" class="form-control" name="postal" placeholder="A1A 1A1" id="postal" value="">
                            </div>
                            <div class="col-lg-4 col-lg-4 col-sm-12 col-12">
                                <button type="button" class="btn enrol-btn" onClick=GetMember() style="padding:8px 28px !important;margin-top: 22px;">Find Account</button>
                            </div>
                            <p id="office_div_error" class="text-danger" style="padding: 14px;"></p>
                        </div>
                        <div class="row cs-form-new-membr dashboard-welcome-wrap" style="display:none;" id="member_data">  
                            <div class="col-lg-4 col-lg-4 col-sm-12 col-12">
                        ...
                        <div class="row mt-2">   
                            ...
                            <div class="col-lg-3 col-lg-3 col-sm-12 col-12"> 
                                ...
                                <a class="btn enrol-btn" href="{{route('member.login')}}"> Cancel</a>
    ...
    function GetMember(){
        ...
        if(phone != '' && postal != ''){
            ...
            $.ajax({
                url:"{{ route('getmember') }}",
                method:"POST",
                data:{fcb_id:fcbid,telephone:phone,postal_code:postal},
                success:function(data)
                {
                    if(data != 'not found'){
                        $('.modal-title p').show();
                        ...
                        $('#new_pass').hide();
                        $('#h5').hide();
                        $('#office_div_error').empty().append('Telephone or postal code does not match account holder information, please correct or call FCB support');
                    }
                }
            });
        }else{
