...
<section class="health-and-dental" id="health-and-dental">
    <div class="container">
        ...
        @if($previous || $next)
        <span class="date-year-value prev-next-div">
        @endif  
        ...
        <div class="ontario-health">
            ...
            <div class="date-year">
                <span class="date-year-value">{{date_format($news->created_at,'M d, Y')}}</span>
            </div>
            <div class="share-story">
                ...
                <ul class="story-icons">
                    <li>
                        ...
                        <a href="https://www.twitter.com/" target="_blank" data-toggle="tooltip" title="Twitter">
                            <i class="fab fa-twitter"></i>
                        </a>
                        <a href="https://www.reddit.com" target="_blank" data-toggle="tooltip" title="Reddit">
                            <i class="fab fa-reddit-alien"></i>
                        </a>
                        <a href="https://www.linkedin.com" target="_blank" data-toggle="tooltip" title="LinkedIn">
                            <i class="fab fa-linkedin-in"></i>
                        </a>
                        <a href="https://www.whatsapp.com" target="_blank" data-toggle="tooltip" title="WhatsApp">
                            <i class="fab fa-whatsapp"></i>
                        </a>
                        <a href="https://www.tumblr.com" target="_blank" data-toggle="tooltip" title="Tumblr">
                            <i class="fab fa-tumblr"></i>
                        </a>
                        <a href="https://www.pinterest.com" target="_blank" data-toggle="tooltip" title="Pinterest">
                            <i class="fab fa-pinterest-p"></i>
                        </a>
                        <a href="https://www.vk.com" target="_blank" data-toggle="tooltip" title="Vk">
                            <i class="fab fa-vk"></i>
                        </a>
                        <a href="https://www.xing.com/" target="_blank" data-toggle="tooltip" title="Xing">
                            <i class="fab fa-xing"></i>
                        </a>
                        <a href="https://www.gmail.com" target="_blank" data-toggle="tooltip" title="Email">
