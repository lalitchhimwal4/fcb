            ...
            <div class="container">
                <form action="{{route('provider.submit_claim_step7')}}" method="post">
                    <div class="enroll-content-wrap">
                        ...
                        <h5 class="claim-form-heading">Treatment Summary</h5>
                        <div class="form">
                            <div class="fcb-payment-review">
                                <div style="display:none" id="pro_detls">
                                    <h5 class="claim-form-heading">Provider Details</h5>
                                ...
                                <div style="display:none" id="mem_detls">
                                    <h5 class="claim-form-heading">Member Details</h5>
                                    <table class="table claim-submission-table">
                                        <thead>
                                            <tr>
                                                <th>Policy Number</th>
                                ...
                                <h5 class="claim-form-heading" style="margin-bottom:20px;margin-top:20px;">Treatment Eligibility Details</h5>
                                <table class="table">
                                    <thead>
                                        <tr>
                                ...
                                <h5 class="claim-form-heading" style="margin-bottom:20px;">Treatment Summary Details</h5>    
                        <div class="form">
                            <div class="fcb-payment-review">
                                ...
                                <table class="table">
                                    ...
                                    <?php $process_date = $clinical_services_validated['claim']['processDate'];
                                            ...
                                            if($clinical_services_validated['claim']['claimCode'] == ''){
                                        ...
                                        <tr>  
                                            ...
                                            @endif
                                            <td>{{$process_date}}</td>
                                            <td>${{number_format($clinical_services_validated['claim']['totalPatientPaysAmount'],2) ?? '-'}}</td></tr>
