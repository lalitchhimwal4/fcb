            ...
            <div class="container">
                <div class="family-hd-wrap d-flex flex-wrap align-items-center justify-content-between">
                    <div class="family-name">
                        <h4>Claim Reference No. {{$claim->reference_number}}</h4>
                        <p>Date Processed {{$claim->processed_date}}</p>
                    </div>
        ...
        <div class="enroll-content-outer provider-dashboard edit-provider-details">
            <div class="container">
                        ...
                        <div class="form-group">
                            <table class="table claim-eob-table">
                                ...
                                <tbody>
                                    <tr>
                                        <td>Patient pays</td>
                                        <td class="eob-amount highlighted">${{number_format((float)$claim->patient_pays_amount, 2, '.', '')}}</td>
                                    </tr>
                                    <tr>
                                        <td>Submitted amount</td>
                                        <td class="eob-amount">${{number_format((float)$claim->submitted_amount, 2, '.', '')}}</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                            ...
                            <table class="table claim-eob-table">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="eob-amount">${{number_format((float)$claim->fcb_contracted_rate, 2, '.', '')}}</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                ...
                <div class="claim-eob-lines">
                    <h5 class="claim-eob-h5">Claim Details</h5>
                    <div class="edit-prv-off-row">
                        <div class="form-group">
                            ...
                            <table class="table claim-eob-table">
                                ...
                                <tbody>
                                    @foreach($claim_lines as $i => $line)
                                    <tr>
                                        <td>{{$i + 1}}</td>
                                        <td>{{$line->service_code}}</td>
                                        <td>{{$line->description}}</td>
                                        <td>${{$line->fcb_contracted_rate}}</td>
                                        <td>${{$line->submitted_amount}}</td>
                                        <td>${{$line->patient_pays_amount}}</td>
                                    </tr>
                                    @endforeach
                                </tbody>
                            </table>
