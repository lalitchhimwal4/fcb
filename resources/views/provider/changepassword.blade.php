@section('title','Provider-Change Password')
        ...
        <div class="enroll-content-outer">
            <div class="container">
                <div class="enroll-content-wrap change-pass-cstm-wrap">
                    <form action="{{route('provider.updatepassword')}}" name="provider_change_password_form" id="provider_change_password_form" method="post" class="marginform">
                        @csrf
...
$(document).ready(function() {
    ...
    if ($("#provider_change_password_form").length > 0) {

        $("#provider_change_password_form").validate({
